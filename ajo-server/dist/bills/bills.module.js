...
exports.BillsModule = BillsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: bill_transaction_schema_1.BillTransaction.name, schema: bill_transaction_schema_1.BillTransactionSchema }]),
            wallet_module_1.WalletModule,
            notifications_module_1.NotificationsModule,
            users_module_1.UsersModule,
        ],
        controllers: [bills_controller_1.BillsController],
        providers: [bills_service_1.BillsService, vtpass_service_1.VTPassService],
